...
public class GlobalExceptionHandler {
    ...
    public ProblemDetail handleInventoryNotFoundException( InventoryNotFoundException ex ) {
    ...
    public ProblemDetail handleReservationNotFoundException( ReservationNotFoundException ex ) {
        return buildProblemDetail(HttpStatus.NOT_FOUND, "Reservation Not Found", ex.getMessage());
    }

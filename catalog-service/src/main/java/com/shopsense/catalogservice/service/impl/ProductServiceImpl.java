...
public class ProductServiceImpl implements ProductService {
    ...
    public ProductResponse createProduct( ProductRequest request ) {
        ...
        Category category = categoryRepository.findByIdAndActive(request.getCategoryId(), true)
                .orElseThrow(() -> new ResourceNotFoundException("Active category not found with id: " + request.getCategoryId()));

...
public class CartController {
    ...
    @PostMapping("/items")
    public ResponseEntity<CartResponse> addItem( @RequestHeader("X-User-Id") UUID userId, @Valid @RequestBody AddToCartRequest request ) {
    ...
    public ResponseEntity<CartResponse> updateItem( @RequestHeader("X-User-Id") UUID userId, @PathVariable UUID productId, @Valid @RequestBody UpdateCartItemRequest request ) {
        CartResponse cartResponse = cartService.updateItem(userId, productId, request);
        return ResponseEntity.ok(cartResponse);
    }

    @DeleteMapping("/items/{productId}")
    public ResponseEntity<Void> removeItem( @RequestHeader("X-User-Id") UUID userId, @PathVariable UUID productId ) {

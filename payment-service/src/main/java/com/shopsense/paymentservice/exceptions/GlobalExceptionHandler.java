...
public class GlobalExceptionHandler {
    ...
    public ProblemDetail handleRazorpayException( RazorpayException e ) {
        return buildProblemDetail(HttpStatus.BAD_REQUEST, "Razorpay Exception", e.getMessage());
    }
    ...
    public ProblemDetail handlePaymentException( PaymentException ex ) {
        return buildProblemDetail(ex.getStatus(), "Payment Exception", ex.getMessage());
    }

    @ExceptionHandler(GatewayException.class)
    public ProblemDetail handleGatewayException( GatewayException ex ) {
        return buildProblemDetail(ex.getStatus(), "Payment Gateway Exception", ex.getMessage());
    }

    @ExceptionHandler(WebhookVerificationException.class)
    public ProblemDetail handleWebhookVerificationException( WebhookVerificationException ex ) {
        return buildProblemDetail(ex.getStatus(), "Webhook Verification Exception", ex.getMessage());
    }
